...
assertion about the local Emails process; it must match `EMAILS_MACHINE_ID`,
`MACHINE_ID`, or the managed-host name.
...
The REST API is local-dashboard scoped. For multi-host orchestration, run the CLI or
