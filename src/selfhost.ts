...
export class EmailsSelfHostClient {
  ...
  private async request<T>(method: string, path: string, opts: { body?: unknown; query?: Record<string, unknown>; init?: RequestInit }): Promise<T> {
    ...
    async getCurrentPrincipal(init?: RequestInit): Promise<{ "principal_type": "apikey"; "kid": string; "tenant": { "id": string; "slug": string; "name": string; "status": string } | { "id": string }; "scopes": Array<string> } | { "principal_type": "fleet"; "sub": string; "tenant": { "id": string; "slug": string; "name": string; "status": string } | { "id": string }; "scopes": Array<string> } | { "principal_type": "user"; "user": ({ "id": string; "email": string; "name": string | null; "status": string; "email_verified": boolean; "global_role"?: "user" | "super_admin"; "is_primary_super_admin"?: boolean; "created_at": string }) | null; "tenant": { "id": string; "slug": string; "name": string; "status": string } | { "id": string }; "role": "owner" | "admin" | "member" | "viewer"; "scopes": Array<string>; "memberships": Array<{ "tenant_id": string; "slug": string; "name": string; "role": "owner" | "admin" | "member" | "viewer" }>; "email_identities": Array<EmailIdentity> }> {
