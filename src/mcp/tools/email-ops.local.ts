...
export function registerEmailOpsTools(server: McpServer): void {
  ...
  async (input) => {
    try {
      ...
      const { createSentEmailLedger, storeSentEmailContent } = await import('../../lib/sent-ledger.local.js');
      const { getTemplate, renderTemplate } = await import('../../db/templates.local.js');
      const { getActiveProvider, getProvider } = await import('../../db/providers.local.js');
      const { getWarmingSchedule } = await import('../../db/warming.local.js');
  ...
  async (input) => {
    try {
      const { listEmails } = await import('../../db/emails.local.js');
  ...
  async ({ query, since, limit, offset }) => {
    try {
      const { searchEmails } = await import('../../db/emails.local.js');
  ...
  async ({ email_id }) => {
    try {
      const { getEmail } = await import('../../db/emails.local.js');
  ...
  async ({ email_id }) => {
    try {
      const { getEmail } = await import('../../db/emails.local.js');
      const { getEmailContent } = await import('../../db/email-content.local.js');
      const { resolveId, EmailNotFoundError } = await import('../helpers.js');
      const id = resolveId("emails", email_id);
      const email = getEmail(id);
      if (!email) throw new EmailNotFoundError(id);
  ...
  async ({ provider_id }) => {
    try {
      const { syncProvider, syncAll } = await import('../../lib/sync.local.js');
      const { resolveId } = await import('../helpers.js');
  ...
  async ({ provider_id, period }) => {
    try {
      const { getLocalStats } = await import('../../lib/stats.local.js');
      const { resolveId } = await import('../helpers.js');
  ...
  async ({ limit, offset }) => {
    try {
      const { listTemplateSummaries } = await import('../../db/templates.local.js');
  ...
  async ({ name_or_id }) => {
    try {
      const { getTemplate } = await import('../../db/templates.local.js');
  ...
  async ({ name_or_id }) => {
    try {
      const { deleteTemplate } = await import('../../db/templates.local.js');
  ...
  async ({ suppressed, limit, offset }) => {
    try {
      const { listContacts } = await import('../../db/contacts.local.js');
  ...
  async ({ email }) => {
    try {
      const { suppressContact } = await import('../../db/contacts.local.js');
  ...
  async ({ email }) => {
    try {
      const { unsuppressContact } = await import('../../db/contacts.local.js');
  ...
  async (input) => {
    try {
      const { getDatabase } = await import('../../db/database.js');
      const { createScheduledEmail } = await import('../../db/scheduled.local.js');
      const { getTemplate, renderTemplate } = await import('../../db/templates.local.js');
      const { getActiveProvider } = await import('../../db/providers.local.js');
      const { resolveId } = await import('../helpers.js');
      const db = getDatabase();
      let providerId: string;
      if (input.provider_id) {
  ...
  async ({ status, limit, offset }) => {
    try {
      const { listScheduledEmailSummaries } = await import('../../db/scheduled.local.js');
  ...
  async ({ id }) => {
    try {
      const { cancelScheduledEmail } = await import('../../db/scheduled.local.js');
      const { resolveId } = await import('../helpers.js');
